...
urlpatterns = [
    ...
    # Sales Side pages
     path("sales-login/", SalesLoginView.as_view(), name="saleslogin"),
     path("sales-home/", SalesHomeView.as_view(), name="saleshome"),
     path("sales-order/<int:pk>/", SalesOrderDetailView.as_view(),name="salesorderdetail"),

     path("sales-all-orders/", SalesOrderListView.as_view(), name="salesorderlist"),

     path("sales-order-<int:pk>-change/", SalesOrderStatuChangeView.as_view(), name="salesorderstatuschange"),
